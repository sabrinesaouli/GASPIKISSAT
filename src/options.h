...
#define OPTIONS                                                                \
  ...
  OPTION(crossover, 95, 0, 100, "crossover rate in percent")                   \
  ...
  OPTION(generations, 40, 1, 300, "number of generations")                     \
  ...
  OPTION(mutation, 88, 0, 100, "mutation rate in percent")                     \
  ...
  OPTION(population, 20, 1, 300, "population size")                            \
